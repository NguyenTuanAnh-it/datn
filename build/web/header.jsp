<%-- 
    Document   : header
    Created on : Feb 17, 2025, 10:47:23 AM
    Author     : ADMIN
--%>
                        ...
                        <div class="col-sm-6">
                            <div class="contactinfo">
                                <ul class="nav nav-pills">
                                    <li><a href="#"><i class="fa fa-phone"></i> +84 981430602</a></li>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="logo pull-left">
                                <a href="index.jsp">
                                    <img src="images/home/veganlogo.jpg" alt="Logo" width="300" height="100" />
                                </a>
                        ...
                        <div class="col-sm-8">
                            <div class="shop-menu pull-right">
                                <ul class="nav navbar-nav">
                                    <li><a href="login?command=logout"><i class="fa fa-user"></i><%= (session.getAttribute("customerName") != null) ? session.getAttribute("customerName") : ""%></a></li>
