...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <div class=\"text-xs font-weight-bold text-danger text-uppercase mb-1\">Đơn đặt hàng mới</div>\n");
      out.write("                            <div class=\"h5 mb-0 font-weight-bold text-gray-800\">\n");
      out.write("                                <span id=\"new-orders-count\">0</span> \n");
      out.write("                            </div>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"col-auto\">\n");
      out.write("                            <i class=\"fas fa-shopping-cart fa-2x text-gray-300\"></i>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      ...
      out.write("                    <div class=\"row no-gutters align-items-center\">\n");
      out.write("                        <div class=\"col mr-2\">\n");
      out.write("                            <div class=\"text-xs font-weight-bold text-success text-uppercase mb-1\">Doanh thu trong ngày</div>\n");
      ...
      out.write("            <thead>\n");
      out.write("                <tr>\n");
      out.write("                    <th style=\"width: 15%;\">Ngày Đặt Hàng</th>\n");
      out.write("                    <th style=\"width: 25%;\">Tên Người Nhận</th>\n");
      out.write("                    <th style=\"width: 15%;\">Trạng Thái</th>\n");
      out.write("                    <th style=\"width: 15%;\">Số Điện Thoại</th>\n");
      out.write("                    <th style=\"width: 20%;\">Địa Chỉ</th>\n");
      out.write("                    <th style=\"width: 20%;\">Tổng tiền</th>\n");
      out.write("                    <th style=\"width: 10%;\">Phương Thức TT</th>\n");
      out.write("                </tr>\n");
      out.write("            </thead>\n");
      out.write("            <tbody>\n");
      out.write("                ");
      ...
      out.write("    </ul>\n");
      out.write("\n");
      out.write("    <p class=\"text-muted text-center mt-2\">\n");
      out.write("        Tổng số đơn hàng: ");
      ...
      out.write("\n");
      out.write("    <script>\n");
      out.write("        function updateNewOrdersCount() {\n");
      out.write("        fetch('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${pageContext.request.contextPath}", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("/dashboard')\n");
      out.write("                .then(response => {\n");
      out.write("                if (!response.ok) {\n");
      out.write("                throw new Error('Lỗi khi gọi API: ' + response.status);\n");
      out.write("                }\n");
      out.write("                return response.json();\n");
      out.write("                })\n");
      out.write("                .then(data => {\n");
      out.write("                let countElement = document.getElementById('new-orders-count');\n");
      out.write("                        if (countElement) {\n");
      out.write("                countElement.textContent = data.count;\n");
      out.write("                } else {\n");
      out.write("                console.error(\"❌ Lỗi: Phần tử #new-orders-count không tồn tại trên trang.\");\n");
      out.write("                }\n");
      out.write("                })\n");
      out.write("                .catch(error => console.error('❌ Lỗi khi lấy dữ liệu đơn hàng mới:', error));\n");
      out.write("        }\n");
      out.write("\n");
      out.write("        // Cập nhật mỗi 10 giây\n");
      out.write("        setInterval(updateNewOrdersCount, 10000);\n");
      out.write("                updateNewOrdersCount();\n");
      out.write("    </script>\n");
      out.write("\n");
    ...
    try {
      ...
      if (_jspx_eval_c_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                        </td>\n");
          out.write("                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.recipientName}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                        <td>\n");
          out.write("                            ");
          ...
          out.write("</td>\n");
          out.write("                        <td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.paymentMethod}", java.lang.String.class, (PageContext)_jspx_page_context, null));
          out.write("</td>\n");
          out.write("                    </tr>\n");
          out.write("                ");
  ...
  private boolean _jspx_meth_c_when_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.status == 'PENDING'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_0 = _jspx_th_c_when_0.doStartTag();
    if (_jspx_eval_c_when_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                    <span class=\"badge bg-warning text-dark\">Chờ Xử Lý</span>\n");
        out.write("                                ");
  ...
  private boolean _jspx_meth_c_when_1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.status == 'shipping'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_1 = _jspx_th_c_when_1.doStartTag();
    if (_jspx_eval_c_when_1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                    <span class=\"badge bg-warning text-dark\">Đang vận chuyển</span>\n");
        out.write("                                ");
  ...
  private boolean _jspx_meth_c_when_2(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.status == 'canceled'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_2 = _jspx_th_c_when_2.doStartTag();
    if (_jspx_eval_c_when_2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                    <span class=\"badge bg-success\">Đã hủy</span>\n");
        out.write("                                ");
  ...
  private boolean _jspx_meth_c_when_3(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context, int[] _jspx_push_body_count_c_forEach_0)
    ...
    _jspx_th_c_when_3.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${order.status == 'delived'}", java.lang.Boolean.class, (PageContext)_jspx_page_context, null)).booleanValue());
    int _jspx_eval_c_when_3 = _jspx_th_c_when_3.doStartTag();
    if (_jspx_eval_c_when_3 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                                    <span class=\"badge bg-success\">Đã giao hàng</span>\n");
        out.write("                                ");
  ...
  private boolean _jspx_meth_c_if_0(PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                <a class=\"page-link\" href=\"dashboard?page=");
